...
if __name__ == '__main__':
    ...
    (train_ratings, test_ratings), (users, items) = load_train_test_ratings(
        'datasets/movielens/train2id.csv',
        'datasets/movielens/test2id.csv'
    )
    ...
    print(top_k_metrics(test_ratings, ratings_pred, k= 1))
    print(top_k_metrics(test_ratings, ratings_pred, k= 3))
    print(top_k_metrics(test_ratings, ratings_pred, k= 5))
    print(top_k_metrics(test_ratings, ratings_pred, k=10))
    print(top_k_metrics(test_ratings, ratings_pred, k=15))
